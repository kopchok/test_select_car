...
abstract class $CarModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? brand, String? type});
}
...
class _$CarModelImpl implements _CarModel {
  _$CarModelImpl({this.id, this.brand, this.type});
  ...
  @override
  String toString() {
    return 'CarModel(id: $id, brand: $brand, type: $type)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, brand, type);
...
abstract class _CarModel implements CarModel {
  factory _CarModel({final int? id, final String? brand, final String? type}) =
      _$CarModelImpl;
